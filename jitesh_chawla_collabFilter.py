...
def K_nearest_neighbors(user1,k):
    ...
    # for user in dict(k_nearest_list[:k]).keys():
    #     print(user)
    # print(utility_matrix1[item]['cond0155'])
...
def Predict(user1, item, k_nearest_list):
    ...
    # for user in (dict(k_nearest_list[:k])).keys():
    #     if not nm.isnan(utility_matrix1[item][user]):
    #         k_filtered_dict[user] = (dict(k_nearest_list))[user]
    ...
    # predict_num_final = avg_ratings_dict[kuser] + predict_num
    # print(avg_ratings_dict[user1])
    # print(predict_num/predict_denom)
    # print(predict_num)
    # print(predict_denom)
